  ...
  return (
    ...
    >
      ...
      <input
        ...
        className={`w-full sm:w-3/4 lg:w-1/2 xl:w-1/3 rounded-md ${
      ...
      <textarea
        ...
        } focus:outline-none w-full sm:w-3/4 lg:w-1/2 xl:w-1/3 focus:ring-1 focus:ring-offset-1 focus:ring-offset-transparent`}
